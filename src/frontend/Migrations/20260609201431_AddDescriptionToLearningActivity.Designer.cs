...
namespace Frontend.Migrations
{
    ...
    [Migration("20260609201431_AddDescriptionToLearningActivity")]
    partial class AddDescriptionToLearningActivity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Frontend.Models.Entities.ChallengeAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Class_Challenges", (string)null);
                });
            ...
            modelBuilder.Entity("Frontend.Models.Entities.ChallengeAssignment", b =>
                {
                    b.HasOne("Frontend.Models.Entities.Challenge", "Challenge")
                        .WithMany()
                        .HasForeignKey("ChallengeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Frontend.Models.Entities.Classroom", "Classroom")
                        .WithMany()
